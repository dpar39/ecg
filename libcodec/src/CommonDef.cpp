...
bool compare_files(const char * f1, const char * f2)
{
    ...
    if (file_len != file_len2)
        cout << "      The length of files are different. Comparing content..." << endl;
    ...
    {
        size_to_read = (file_len - already_read > buffer_len) ? buffer_len : file_len - already_read;
